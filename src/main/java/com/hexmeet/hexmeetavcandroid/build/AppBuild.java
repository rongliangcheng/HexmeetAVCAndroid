package com.hexmeet.hexmeetavcandroid.build;
...
public class AppBuild {
    ...
    private final String jenkinsBuildUrl="http://172.27.0.12:8080/view/HexMeet%20AVC/job/swep-android-evsdk-avc-hexmeet-2.6/lastSuccessfulBuild/artifact/";
    private final String outputPath="D:\\Dev\\workspace\\Jenkins\\workspace\\Hexmeet_AVC_Android\\build\\";
...
//    }
    ...
    public AppBuild(){
        ...
        Pattern pattern = Pattern.compile("\"HexMeet-([\\d|.]+)-release.apk\"");
